...
class LoginActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // The default_web_client_id is generated by google-services plugin if Google Sign-In is enabled in Firebase.
        // We use a safe fallback to prevent compilation errors if the JSON is incomplete.
        val webClientIdResId = resources.getIdentifier("default_web_client_id", "string", packageName)
        val webClientId = if (webClientIdResId != 0) getString(webClientIdResId) else "YOUR_WEB_CLIENT_ID_HERE"
